...
export const CANONICAL_BASE_URL = 'https://www.animedungeons.wiki';
...
function getAnimeDungeonsBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'animedungeons.wiki' ||
      parsedUrl.hostname === 'www.animedungeons.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const animeDungeonsBaseUrl = getAnimeDungeonsBaseUrl(configuredBaseUrl);
  if (animeDungeonsBaseUrl) {
    return animeDungeonsBaseUrl;
  }
