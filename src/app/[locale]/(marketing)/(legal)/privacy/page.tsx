...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Privacy Policy | Anime Dungeons Wiki',
    description:
      'Privacy policy for the independent Anime Dungeons Wiki and Roblox guide site.',
    locale,
    pathname: '/privacy',
  });
}
    ...
    <div className="bg-[#070812] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Anime Dungeons Wiki is an independent Roblox guide site. We do not
          require accounts for browsing codes, classes, dungeon routes, gear
          guides, update coverage, official links, or safety pages.
        </p>
        <p className="leading-8 text-[#CBD5E1]">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Privacy questions can be sent to hello@animedungeons.wiki.
        </p>
      </Container>
    </div>
  );
