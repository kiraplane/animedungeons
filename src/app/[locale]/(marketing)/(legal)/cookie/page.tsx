...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Anime Dungeons Wiki',
    description:
      'How Anime Dungeons Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#070812] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Anime Dungeons Wiki uses essential cookies and similar technologies to
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Questions about this policy can be sent to hello@animedungeons.wiki.
        </p>
      </Container>
    </div>
  );
