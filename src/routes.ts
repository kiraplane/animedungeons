...
export enum Routes {
  ...
  FirstClassGuide = '/guides/choose-first-class',
  FirstDungeonGuide = '/guides/first-dungeon-route',
  LootGuide = '/guides/loot-upgrade-checklist',
  PartyGuide = '/guides/solo-vs-party',
