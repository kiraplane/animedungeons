...
export const codeStatusSummary = {
  ...
  message:
    'UPDATE1.5 is the current update-matched test candidate. Other strings remain reported or previous entries because the Roblox description does not publish a code list.',
};
