...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/animedungeons-codes?\/?$/, target: '/codes' },
  {
    pattern: /^\/animedungeons-tier-list\/?$/,
    target: '/classes',
  },
  { pattern: /^\/animedungeons-wiki\/?$/, target: '/' },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'animedungeons.wiki',
    'www.animedungeons.wiki',
  ]);
  const canonicalHost = 'www.animedungeons.wiki';
