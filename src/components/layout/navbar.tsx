...
const customNavigationMenuTriggerStyle = cn(
  ...
  'hover:bg-white/5 hover:text-[#46D7FF]',
  'focus:bg-white/5 focus:text-[#46D7FF]',
  'data-active:bg-transparent data-active:font-semibold data-active:text-[#46D7FF]',
  'data-[state=open]:bg-white/5 data-[state=open]:text-[#46D7FF]'
);
...
export function Navbar({ scroll }: NavBarProps) {
  ...
  return (
    <section
      className={cn(
        'sticky inset-x-0 top-0 z-40 border-white/10 border-b py-4 text-white transition-all duration-300',
        scroll
          ? scrolled
            ? 'bg-[#070812]/95 backdrop-blur-md supports-backdrop-filter:bg-[#070812]/95'
            : 'bg-[#070812]/90 backdrop-blur-md'
          : 'bg-[#070812]/95 backdrop-blur-md'
      )}
    >
