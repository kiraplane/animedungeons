        ...
        <div className="flex items-center justify-end gap-4">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-white/10 text-slate-100"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-white/10 border-t bg-[#070812] text-foreground backdrop-blur-md animate-in fade-in-0"
    >
