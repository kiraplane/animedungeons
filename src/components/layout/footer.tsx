...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-white/10 border-t bg-[#070812] text-[#F6FBFF]',
        className
      )}
    >
                ...
                <div className="flex items-center gap-2">
                  {socialLinks?.map((link) => (
                    <a
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/10 text-slate-400 hover:border-[#46D7FF] hover:bg-[#101326] hover:text-white"
                    >
                      ...
                      <li key={item.title}>
                        {item.isImage ? (
                          ...
                          <LocaleLink
                            ...
                            title={item.linkTitle}
                            className={cn(
                              'text-sm text-slate-400 hover:text-[#46D7FF]',
      ...
      <div className="border-white/10 border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-slate-400 text-sm">
            Independent guide site. Not affiliated with Roblox or 1B Studio.
          </span>
        </Container>
      </div>
    </footer>
