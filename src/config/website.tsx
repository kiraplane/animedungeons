...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/animedungeons/media/experience.jpg',
      logoLight: '/animedungeons/icon.png',
      logoDark: '/animedungeons/icon.png',
    },
    social: {
      github: '',
      twitter: '',
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Anime Dungeons Wiki <hello@animedungeons.wiki>',
    supportEmail: 'hello@animedungeons.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
